...
pin: true
media_subpath: '/assets/img/posts/20190809'
---
...
1. Go to your repository on GitHub. Select the _Settings_ tab, then click _Pages_ in the left navigation bar. In the **Source** section (under _Build and deployment_), select [**GitHub Actions**][pages-workflow-src] from the dropdown menu.  
   ![Build source]({{ "/assets/img/posts/20190809/pages-source-light.png" | relative_url }}){: .light .border .normal w='375' h='140' }
   ![Build source]({{ "/assets/img/posts/20190809/pages-source-dark.png" | relative_url }}){: .dark .normal w='375' h='140' }
